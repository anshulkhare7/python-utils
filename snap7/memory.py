...
if __name__=="__main__":
    plc = S71200('192.168.1.70')  #,debug=True)    
    # print("Connected? ", plc.plc.get_connected())
    # print("CPU Info ", plc.get_cpu_state())	
	print("Reading: ", plc.getMem('MKx100.2'))
    # print("Output value before writing:", ReadMemory(plc,2,100,S7WLByte))
    # # WriteMemory(plc,0,100,S7WLByte,True)
    # # print("Output value after writing:", ReadMemory(plc,0,100,S7WLByte))
    ...
    # data = get_bool(byte, 0, bit)
    # value = 1
    # set_bool(data,0,bit,int(value))
    
    # plc.write_area(0x83, 0, start, data)
